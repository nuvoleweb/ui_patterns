...
namespace Drupal\ui_patterns_sdc\Plugin\UiPatterns\Pattern;
...
/**
 * Detect Single directory components (*.component.yml)  definitions.
 *
 * @UiPattern(
 *   id = "sdc",
 *   label = @Translation("SDC Component Library Pattern"),
 *   description = @Translation("Pattern defined using a *.component.yml file."),
 *   deriver = "\Drupal\ui_patterns_sdc\Plugin\Deriver\SdcComponentDeriver"
 * )
 */
class SdcPattern extends PatternBase {
